        ...
        loading===true || userLoading===true ? <Loader /> : (
            <div className="account">
                ...
                <div className="accountright">
                    ...
                    {
                        myProfile?null:(
                            <Button variant="contained" style={{background:following?"red":"blue"}} onClick={followHandler} disabled={followLoading}>{
            ...
            <div className="DialogBox">
                ...
                {
                    user && user.following.length > 0 ? user.followers.map((follow)=>((
                        <User
                    key={follow._id}
                    userId={follow._id}
                    name={follow.name}
