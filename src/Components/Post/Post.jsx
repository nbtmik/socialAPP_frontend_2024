...
import { UpdatePost, addCommentOnPost, deletePost, likePost } from "../../Actions/Post";
...
const Post=({
    ...
    const handleLike =async()=>{
        ...
        if(isAccount){
            ...
            dispatch(getFollowingPosts());//to update like no
        }
    };
    ...
    const addCommentHandler =async(e)=>{
        ...
        if(isAccount){
            ...
            dispatch(getFollowingPosts());//to update like num without refreshing it
        }
    };
